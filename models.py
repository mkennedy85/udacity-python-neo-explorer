...
class NearEarthObject:
    ...
    def __str__(self):
        ...
        return f"{self.fullname} is a near Earth object with a diameter of {self.diameter:.3f} and {'is' if self.hazardous else 'is not'} hazardous."
...
class CloseApproach:
    ...
    def __init__(self, **info):
        ...
        self.time = cd_to_datetime(info['time']) if info['time'] else None  # TODO: Use the cd_to_datetime function for this attribute.
    ...
    def __str__(self):
        ...
        # The project instructions include one possibility. Peek at the __repr__
        # method for examples of advanced string formatting.
        return f"On {self.time_str}, '{self.fullname}' approaches Earth at a distance of {self.distance:.2f} and a velocity of {self.velocity:.2f} km/s."
